    ...
    >
      ...
      >
        <el-form-item label="系统平台" prop="platform">
          ...
          <el-radio v-model="radio" label="Windows" @change="clearFiles"
            >Windows</el-radio
          >
          <el-radio v-model="radio" label="CentOS" @change="clearFiles"
            >CentOS</el-radio
          >
          <el-radio v-model="radio" label="Ubuntu" @change="clearFiles"
            >Ubuntu</el-radio
          >
          <el-radio v-model="radio" label="Manual" @change="clearFiles"
            >用户手册</el-radio
          >
        </el-form-item>
        <el-form-item
          v-for="(item, index) in ruleForm.testList"
          :key="index"
          label="上传安装包"
          inline="true"
        >
        ...
        <el-form-item>
          <el-button type="primary" @click="closeDiagle()" align="center"
            >关闭窗口</el-button
          >
          <el-button type="primary" @click="getFileDetail()" align="center"
            >查看文件列表</el-button
          >
        </el-form-item>
      </el-form>
